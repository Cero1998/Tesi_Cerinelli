...
In particolare lo studio di tutto ciò che riguarda la vita stessa, non solo degli uomini ma anche di ogni organismo vivente, ha dato vita alla \textit{Biologia}.
...
Una loro unione nel corso degli anni è stata più che naturale, portando alla nascita di un nuovo campo di studi: la \textit{bioinformatica}.
\section{Bioinformatica}\label{sec:cap_one_bioinfo}
Il genoma contiene tutte le
informazioni necessarie allo sviluppo e al funzionamento di un organismo vivente
ed è normalmente costituito da DNA.
Tutte le cellule di un organismo hanno sostanzialmente lo stesso genoma
ma possono avere epigenomi e trascrittomi molto diversi.\footnote{In breve, un genoma è ciò che che differenzia una cellula di un osso da una cellula epidermica.}

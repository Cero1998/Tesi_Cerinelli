...
tra geni in un dataset 10x Visium.  
...
L'obiettivo di questa seconda fase era valutare se le relazioni spaziali individuate tra geni corrispondessero anche a pattern nei dati di espressione.  
Sebbene non siano emersi cluster alternativi significativi, l'esperimento ha permesso di validare la correttezza del
metodo proposto, mostrando che la pipeline è in grado di analizzare in modo coerente e riproducibile la distribuzione
spaziale dei geni.

...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.5\textwidth]{immagini/spot_cubo.png}
...
Dopodichè applichiamo una normalizzazione\footnote{Rendere i pesi comparabili imponendo somma per riga uguale a 1} per ottenere i pesi finali:
\begin{equation}
...
Una alternativa allo smoothing visto sopra è lo \textit{smoothing a due fattori}, ovvero combina i vicini spaziali e la loro somiglianza trascrizionale.

...
\end{enumerate}
Queste 3 fasi sono fondamentali per ottenere per ciascun gene una lista dei vari spot dove il gene ha a 
tutti gli effetti una sua espressione e dove invece quest'ultima non è presente\cite{binaryMasksBonniciGrazioli}.
...
Questa maschera sintetizza il comportamento spaziale del gene, distinguendo le regioni di minima attività a cui è stato assegnato valore 0, da quelle di maggiore espressione a cui è stato assegnato valore 1.
Le maschere così generate costituiscono la rappresentazione compatta e comparabile dei pattern spaziali di ciuascun gene.

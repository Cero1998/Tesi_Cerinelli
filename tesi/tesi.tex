...
\begin{flushright}
	\textit{Non è morto ciò che può attendere in eterno,}\\
  \textit{ e col volgere di strani eoni anche la morte può morire.}\\
  \medskip
  \textit{- H. P. Lovecraft, "La città senza nome" (1921)}
\end{flushright}
\vspace{\stretch{3}}\null
\newpage
\blankpage
...
\null\vspace{\stretch{1}}
\begin{flushright}
	\textit{A tutte le persone che mi vogliono bene}
\end{flushright}
\vspace{\stretch{3}}\null
\newpage
\blankpage
